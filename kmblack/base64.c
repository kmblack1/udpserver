 ...
 */
int32_t
pg_b64_encode(const char *src, int32_t len, char *dst, int32_t dstlen)
{
	char	   *p;
	const char *s,
			   *end = src + len;
 ...
 */
int32_t
pg_b64_decode(const char *src, int32_t len, char *dst, int32_t dstlen)
{
